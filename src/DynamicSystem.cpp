...
///*
	...
	PYBIND11_MODULE(dyns, module_handle) {
		module_handle.doc() = R"pbdoc(
			Numerical Solvers library. Created in MEPhI in 2022
			-----------------------
		...
		#ifdef VERSION_INFO
			module_handle.attr("__version__") = MACRO_STRINGIFY(VERSION_INFO);
		#else
			module_handle.attr("__version__") = "dev";
		#endif
